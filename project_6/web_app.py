...
teams = pd.read_excel('/home/depaula/git_ds/project_6/data/DadosCopaDoMundoQatar2022.xlsx',
                        sheet_name ='selecoes',
                        names = ['Teams_BR',
                                 'Group',
                                 'GroupNumber',
...
cupgames = pd.read_excel('/home/depaula/git_ds/project_6/data/outputEstimativasJogosCopa.xlsx', index_col = 0)
