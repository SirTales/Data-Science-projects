...
teams = pd.read_excel('Data-Science-projects/project_6/data/DadosCopaDoMundoQatar2022.xlsx',
                        sheet_name ='selecoes',
                        names = ['Teams_BR',
                                 'Group',
                                 'GroupNumber',
...
cupgames = pd.read_excel('Data-Science-projects/project_6/data/outputEstimativasJogosCopa.xlsx', index_col = 0)
